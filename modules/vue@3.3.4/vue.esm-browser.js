...
const PublicInstanceProxyHandlers = {
  get({ _: instance }, key) {
    ...
    if (publicGetter) {
      ...
      // css module (injected by vue@3.3.4-loader)
  ...
  for (let i = 0; i < props.length; i++) {
    ...
    if (p.type === 6) {
      if (p.name === "is" && p.value) {
        if (p.value.content.startsWith("vue@3.3.4:")) {
          return true;
        }
      }
    } else {
...
function createCodegenContext(ast, {
  ...
  ssrRuntimeModuleName = "vue@3.3.4/server-renderer",
  ssr = false,
  isTS = false,
  inSSR = false
}) {
...
function resolveComponentType(node, context, ssr = false) {
  ...
  if (isProp) {
    ...
    } else if (isProp.type === 6 && isProp.value.content.startsWith("vue@3.3.4:")) {
...
function buildProps(node, context, props = node.props, isComponent, isDynamicComponent, ssr = false) {
  ...
  for (let i = 0; i < props.length; i++) {
    ...
    if (prop.type === 6) {
      ...
      if (name === "is" && (isComponentTag(tag) || value && value.content.startsWith("vue@3.3.4:") || false)) {
        continue;
      }
      properties.push(
        createObjectProperty(
      ...
      if (
        ...
        // before children
        isVOn && hasChildren && isStaticArgOf(arg, "vue@3.3.4:before-update")
      ) {
        shouldUseBlock = true;
      }
...
const transformOn$1 = (dir, node, context, augmentor) => {
  ...
  if (arg.type === 4) {
    if (arg.isStatic) {
      ...
      if (rawName.startsWith("vue@3.3.4:")) {
